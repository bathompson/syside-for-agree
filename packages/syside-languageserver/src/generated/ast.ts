...
export interface GumboBlock extends Element {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'GumboBlock';
}

export const GumboBlock = 'GumboBlock';

export function isGumboBlock(item: unknown): item is GumboBlock {
    return reflection.isInstance(item, GumboBlock);
}
...
export interface Membership extends Relationship {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'ActorMembership' | 'ElementFilterMembership' | 'EndFeatureMembership' | 'FeatureMembership' | 'FeatureValue' | 'FramedConcernMembership' | 'GumboMembership' | 'GumboSubclause' | 'Membership' | 'ObjectiveMembership' | 'OwningMembership' | 'ParameterMembership' | 'RequirementConstraintMembership' | 'RequirementVerificationMembership' | 'ResultExpressionMembership' | 'ReturnParameterMembership' | 'SpecSection' | 'StakeholderMembership' | 'State' | 'StateSubactionMembership' | 'StateVarDecl' | 'SubjectMembership' | 'TransitionFeatureMembership' | 'VariantMembership' | 'ViewRenderingMembership';
    isAlias: boolean
}
...
export interface GumboMembership extends Membership {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'GumboMembership' | 'GumboSubclause' | 'SpecSection' | 'State' | 'StateVarDecl';
}

export const GumboMembership = 'GumboMembership';

export function isGumboMembership(item: unknown): item is GumboMembership {
    return reflection.isInstance(item, GumboMembership);
}
...
export interface GumboSubclause extends GumboMembership {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'GumboSubclause';
    specs: SpecSection
}

export const GumboSubclause = 'GumboSubclause';

export function isGumboSubclause(item: unknown): item is GumboSubclause {
    return reflection.isInstance(item, GumboSubclause);
}

export interface SpecSection extends GumboMembership {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'SpecSection';
    state?: State
}

export const SpecSection = 'SpecSection';

export function isSpecSection(item: unknown): item is SpecSection {
    return reflection.isInstance(item, SpecSection);
}

export interface State extends GumboMembership {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'State';
    decls: Array<StateVarDecl>
}
...
export interface StateVarDecl extends GumboMembership {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | FlowConnectionUsage | ForLoopActionUsage | GumboSubclause | IfActionUsage | InvocationExpression | ItemFlow | MultiplicityRange | Namespace | Relationship | SatisfyRequirementUsage | SendActionUsage | SpecSection | State | SysMLFunction | TextualAnnotatingElement | TransitionUsage | Type | WhileLoopActionUsage;
    readonly $type: 'StateVarDecl';
    name: string
    typeName: Reference<PartDefinition>
}

export const StateVarDecl = 'StateVarDecl';

export function isStateVarDecl(item: unknown): item is StateVarDecl {
    return reflection.isInstance(item, StateVarDecl);
}
...
export type SysMlAstType = {
    ...
    GumboBlock: GumboBlock
    GumboMembership: GumboMembership
    GumboSubclause: GumboSubclause
...
export class SysMlAstReflection extends AbstractAstReflection {
    ...
    protected override computeIsSubtype(subtype: string, supertype: string): boolean {
        switch (subtype) {
            ...
            case State:
            case StateVarDecl: {
                return this.isSubtype(GumboMembership, supertype);
            }
