...
/**
 * This extensions implementation of LanguageClientExtension, which allows SysIDE to load and interact with this extension
 */
export class AgreeClientExtension implements LanguageClientExtension<ExtensionContext> {
    onBeforeStart(context: ExtensionContext, config: ServerConfig): MaybePromise<void> {
        const serverPath = Uri.joinPath(context.extensionUri, "dist/languageserver/main.js");
